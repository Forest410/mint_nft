...
module.exports = async (callback) => {
  ...
  await adulam.payToMint({from: buyer1, value: COST })
  ...
  console.log(`Later balance of deployer | ${web3.utils.fromWei(deployerBal.toString(), 'ether')}`)
  console.log(`Later balance of buyer1   | ${web3.utils.fromWei(buyer1Bal.toString(), 'ether')}`)
